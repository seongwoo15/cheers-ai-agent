...
**Q. "uv는 내부 또는 외부 명령이 아닙니다" 라고 뜨면?**  
uv 설치 후 PowerShell을 닫고 다시 열어주세요. 그래도 안 되면 `winget install astral-sh.uv`를 다시 실행하세요.

**Q. 크롬 창이 안 열리면?**  
`uv run playwright install chromium` 명령어를 다시 실행해보세요.
